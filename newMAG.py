...
topic_fn = "Mashup/document-topic-distributions.csv"
cite = "Mashup/citeMashup.csv"
pairs = "Mashup/pairs"
log = "Mashup/exp/log.txt"
attribute_matrix = "Mashup/exp/attribute_M.txt"
att_matrix = {}
...
def trainmodels(logFile):
    ...
    with open(pairs, "r") as c ,  open(fn0, 'w') as output:
        ...
        for n in range(0, 10):  # test_sets.keys():
            ...
            scoreoftopic = "Mashup/exp/%i_scorematrix.txt" % n
